...
def logfire_source(
    ...
    """Load query results from Pydantic Logfire.

    Args:
        read_token: Logfire read token. Uses LOGFIRE_READ_TOKEN/LOGFIRE_TOKEN when not provided.
        sql: SQL query executed by Logfire Query API.
        row_limit: Max rows returned by the query endpoint.
    """
...
def run() -> None:
    ...
    # Keep first runs cheap and easy to debug.
